...
import { createSavingsGoalSchema, updateSavingsGoalSchema, addProgressSchema } from "./savings-goals.validation";
import { uuidParamSchema } from "@/common/validators";
import { authMiddleware } from "@/common/middleware/auth";

const router: Router = Router();

router.get("/", authMiddleware, asyncHandler(savingsGoalController.findAll));
